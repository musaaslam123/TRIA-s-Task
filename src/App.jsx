...
function App() {
  ...
  const clearDeletedHistory = () => {
    if (
      confirm(
        "Are you sure you want to permanently delete all deleted contacts?"
      )
    ) {
      setDeletedContacts([]);
  ...
  return (
    <div className={isDarkMode ? "dark" : ""}>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-800 text-black dark:text-white flex flex-col transition-colors duration-500">
        <div className="flex-1 flex flex-col max-w-6xl mx-auto w-full px-6 py-8 overflow-visible">
          ...
          {/* Two-column layout */}
          <div className="flex flex-col md:flex-row flex-1 gap-12 overflow-visible">
